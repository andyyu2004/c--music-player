...
namespace CMusicPlayer.UI.ApplicationBar
{
    ...
    public partial class ApplicationBar : IApplicationBar
    {
        ...
        private void OnBarMouseDown(object sender, MouseButtonEventArgs e) => BarMouseDown?.Invoke(this, EventArgs.Empty);

        private void OnBarDoubleClick(object sender, MouseEventArgs e) => MaximizeClicked?.Invoke(this, EventArgs.Empty);

        private void OnMinimizeClicked(object sender, EventArgs e) => MinimizeClicked?.Invoke(this, EventArgs.Empty);

        private void OnMaximizeClicked(object sender, EventArgs e) => MaximizeClicked?.Invoke(this, EventArgs.Empty);
