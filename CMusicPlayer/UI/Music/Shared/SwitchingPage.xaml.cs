...
namespace CMusicPlayer.UI.Music.Shared
{
    ...
    internal abstract partial class SwitchingPage
    {
        ...
        protected virtual void OnToArtists(object sender, RoutedEventArgs e)
        {
            ViewFrame.Content = CurrentControl = ArtistListControl;
        }

        protected virtual void OnToAlbums(object sender, RoutedEventArgs e)
        {
            ViewFrame.Content = CurrentControl = AlbumListControl;
        }
        ...
        protected virtual void OnToTracks(object sender, RoutedEventArgs e)
        {
            ViewFrame.Content = CurrentControl = TrackListControl;
        }
    }
