...
namespace CMusicPlayer.Data.Repositories
{
    internal class CloudRepository : ITrackRepository
    {
        ...
        public CloudRepository(NetworkDataSource source) => this.source = source;
        ...
        private static Try<T> TryDeserialize<T>(string s) => JsonConvert.DeserializeObject<T>(s);
    }
}
